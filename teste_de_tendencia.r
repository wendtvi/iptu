...
lowerbound_1995=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1995])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1995])
lowerbound_1996=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1996])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1996])
...
lowerbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2005])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2005])
lowerbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2006])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2006])
lowerbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2007])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2007])
lowerbound_2008=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2008])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2008])


upperbound_1995=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1995])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1995])
upperbound_1996=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1996])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==1996])
...
upperbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2005])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2005])
upperbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2006])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2006])
upperbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2007])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO==2007])
...
for (k in 1:length(levels(merge_data_final$SUBPREF))){
  ...
  if(k!=7&&k!=4&&k!=6&&k!=8&&k!=9&&k!=10&&k!=12&&k!=15&&k!=17&&k!=20&&k!=25&&k!=26&&k!=28){
    ...
    lowerbound_1995=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1995],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1995],na.rm = TRUE)
    lowerbound_1996=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1996],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1996],na.rm = TRUE)
    lowerbound_1997=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1997],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1997],na.rm = TRUE)
    lowerbound_1998=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1998],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1998],na.rm = TRUE)
    lowerbound_1999=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1999],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1999],na.rm = TRUE)
    lowerbound_2000=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2000],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2000],na.rm = TRUE)
    lowerbound_2001=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2001],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2001],na.rm = TRUE)
    lowerbound_2002=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2002],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2002],na.rm = TRUE)
    lowerbound_2003=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2003],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2003],na.rm = TRUE)
    lowerbound_2004=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2004],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2004],na.rm = TRUE)
    lowerbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2005],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2005],na.rm = TRUE)
    lowerbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2006],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2006],na.rm = TRUE)
    lowerbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2007],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2007],na.rm = TRUE)
    lowerbound_2008=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2008],na.rm = TRUE)-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2008],na.rm = TRUE)
    
    
    upperbound_1995=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1995],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1995],na.rm = TRUE)
    upperbound_1996=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1996],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1996],na.rm = TRUE)
    upperbound_1997=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1997],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1997],na.rm = TRUE)
    upperbound_1998=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1998],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1998],na.rm = TRUE)
    upperbound_1999=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1999],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==1999],na.rm = TRUE)
    upperbound_2000=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2000],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2000],na.rm = TRUE)
    upperbound_2001=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2001],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2001],na.rm = TRUE)
    upperbound_2002=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2002],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2002],na.rm = TRUE)
    upperbound_2003=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2003],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2003],na.rm = TRUE)
    upperbound_2004=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2004],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2004],na.rm = TRUE)
    upperbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2005],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2005],na.rm = TRUE)
    upperbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2006],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2006],na.rm = TRUE)
    upperbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2007],na.rm = TRUE)+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$SUBPREF==levels(merge_data_final$SUBPREF)[k]]==2007],na.rm = TRUE)
...
lowerbound_1995=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1995])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1995])
lowerbound_1996=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1996])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1996])
lowerbound_1997=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1997])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1997])
lowerbound_1998=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1998])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1998])
lowerbound_1999=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1999])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1999])
lowerbound_2000=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2000])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2000])
lowerbound_2001=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2001])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2001])
lowerbound_2002=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2002])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2002])
lowerbound_2003=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2003])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2003])
lowerbound_2004=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2004])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2004])
lowerbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2005])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2005])
lowerbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2006])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2006])
lowerbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2007])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2007])
lowerbound_2008=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2008])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2008])


upperbound_1995=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1995])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1995])
upperbound_1996=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1996])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1996])
upperbound_1997=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1997])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1997])
upperbound_1998=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1998])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1998])
upperbound_1999=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1999])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==1999])
upperbound_2000=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2000])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2000])
upperbound_2001=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2001])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2001])
upperbound_2002=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2002])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2002])
upperbound_2003=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2003])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2003])
upperbound_2004=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2004])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2004])
upperbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2005])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2005])
upperbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2006])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2006])
upperbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2007])+sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real<tier1]==2007])
...
lowerbound_1998=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==1998])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==1998])
lowerbound_1999=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==1999])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==1999])
lowerbound_2000=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2000])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2000])
lowerbound_2001=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2001])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2001])
lowerbound_2002=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2002])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2002])
lowerbound_2003=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2003])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2003])
lowerbound_2004=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2004])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2004])
lowerbound_2005=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2005])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2005])
lowerbound_2006=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2006])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2006])
lowerbound_2007=mean(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2007])-sd(merge_data_final$PC_TT_UN[merge_data_final$ANO.DO.EXERCICIO[merge_data_final$aliquota_real[merge_data_final$aliquota_real<tier2]>=tier1]==2007])
